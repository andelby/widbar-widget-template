...
- [SDK on NuGet](https://www.nuget.org/packages/WidBar.SDK)
- [Template](https://github.com/andelby/widbar-widget-template)
- [Showcase](https://github.com/andelby/winbar-showcase)
